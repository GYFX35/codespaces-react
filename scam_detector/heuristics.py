...
URGENCY_KEYWORDS = [
    ...
    "your subscription will be cancelled", "payment declined" # Removed "action needed"
]
...
TOO_GOOD_TO_BE_TRUE_KEYWORDS = [
    ...
    "inheritance", " unclaimed funds", "nigerian prince" # Classic ones
]
...
SUSPICIOUS_TLDS = [
    ...
    '.icu', '.gq', '.cf', '.tk', '.ml', # Often free TLDs abused
