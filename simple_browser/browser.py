...
if __name__ == '__main__':
    ...
    settings.setAttribute(QWebEngineSettings.JavascriptCanOpenWindows, False) # Key for pop-ups
    settings.setAttribute(QWebEngineSettings.PluginsEnabled, False) # Disable plugins like Flash (mostly obsolete but good for minimal)
    settings.setAttribute(QWebEngineSettings.FullScreenSupportEnabled, True) # Allow full screen if page requests
