...
def main():
    ...
    group.add_argument(
        "-t", "--text",
        help="Text content to analyze for scams."
    )
    group.add_argument(
        "-f", "--file",
        help="Path to a plain text file to read content from."
    )
    group.add_argument(
        "--stdin",
        action="store_true",
    ...
    if args.text:
        ...
        print("Reading from stdin. Press Ctrl+D (Linux/macOS) or Ctrl+Z then Enter (Windows) to end input.")
    ...
    print("Always exercise caution and use your best judgment. Do not rely solely on this tool for security decisions.")
